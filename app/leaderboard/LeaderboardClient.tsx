...
import { Trophy, Edit3, RefreshCw, Loader2, Layers } from "lucide-react";
...
const TABS = [
  ...
  { id: "mostPixels"   as const, label: "most pixels",   icon: Layers,  desc: "Most pixels painted onto the canvas" },
] as const;
